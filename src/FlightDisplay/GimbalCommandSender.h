...
public:
    ...
    Q_INVOKABLE void sendPitchDown();           // Pitch = -90°
    Q_INVOKABLE void sendPitchCenter();         // Центрувати гімбал
    Q_INVOKABLE void sendReadPositionCommand(); // Запит кута
    Q_INVOKABLE void startAutoUpdate();         // Старт таймера
    Q_INVOKABLE void stopAutoUpdate();          // Стоп таймера
